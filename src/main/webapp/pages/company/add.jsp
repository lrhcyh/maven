...
<form id="activityForm" action="${basePath}company/addCompany.form" method="post" style="margin: 10px 30px; line-height: 35px;">
...
<script type="text/javascript">
	...
	function save() {
		...
		if ($("#activityForm").form("validate")) {
			var formJson = getFormToJson("activityForm");
			var url;
			var dataStr = '{' + formJson + '}';
			var params = 'data=' + dataStr;
			
			url = basepath + "/company/addCompany.form";
			ajaxUtils.post(url, params, function(json) {
