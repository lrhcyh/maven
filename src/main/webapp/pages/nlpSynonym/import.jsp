...
<form id="activityForm" action="${basePath}nlpSynonym/importExport.form" method="post" enctype="multipart/form-data" style="margin: 10px 30px; line-height: 35px;">
  	 <input type="file" name="file" iconCls="icon-large-chart">  
	    
    <br/><br/>
    <div colspan="2">
	    <a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="importSynonym();">上传</a> 
