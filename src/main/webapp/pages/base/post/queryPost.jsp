...
<script type="text/javascript" src="js/base/statistics.js"></script>
 ...
 <div class="easyui-layout" style="width: 100%; height: 100%;">
  		<div region="north" style="height: 30px" data-options="border:false">
  			<div class="easyui-panel" data-options="fit:true">
				...
				<a id="excel" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-link'">Excel</a>
			</div>
  		</div>
  					...
  					<div class="easyui-tabs " style="width:200px;height:100%; " id="tabs">
					  		<div title="一维统计图" >
						  		<table class="easyui-datagrid" id="oneCartogram"  
									data-options="singleSelect:true,collapsible:true,url:'statistics/findCondition.form',method:'get',onSelect:
					    			function(index,row) {
							...
							data-options="singleSelect:true,collapsible:true,url:'statistics/findTwoCondition.form',method:'get',onSelect:
					    			function(index,row) {
  ...
  <div id="twoWindow" class="easyui-window" title="二维统计表"  data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:500,height:250">
  		<div style="padding:10px 20px 20px 20px">
		    <table cellpadding="5" style="width:400px;">
		    		<tr>
		    			<td width="20%" style="padding:10px 0">横向统计条件:</td>
		    			<td style="padding:10px 5"><input class="easyui-combobox"  id="vertical" style="width:96%" data-options="editable:false,url:'statistics/findCondition.form',method:'get',valueField:'accountcode',textField:'accountname'"></input></td>
		    		</tr>
		    		<tr>
		    			<td style="padding:10px 0">纵向统计条件:</td>
		    			<td style="padding:10px 5"><input class="easyui-combobox"  id="horizontal" style="width:96%" data-options="editable:false,url:'statistics/findCondition.form',method:'get',valueField:'accountcode',textField:'accountname'"></input></td>
		    		</tr>
...
<!--   <div id="commonWindow" class="easyui-window" title="常用统计"  data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:470,height:400">
  ...
  <div  class="easyui-window" id="commonTwoWindow" title="请输入统计名称" data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:300,heigth:120,">
   <p>&nbsp;</p>
   ...
   <div  class="easyui-window" id="commonOneWindow" title="请输入统计名称" data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:300,heigth:120,">
   <p>&nbsp;</p>
   ...
   <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
    ...
    <div id="complexBox" class="easyui-window" title="查询"  data-options="collapsible:false,minimizable:false,maximizable:false,closed:true" >
	  <div class="wpy-box" >
	  	<div class="form-item">
 ...
 choicebox(newValue);
  ...
  <div id="openDialog"></div>
    <div  class="easyui-window" id="messageWindow" title="请输入名称" data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:300,heigth:120,">
   <p>&nbsp;</p>
