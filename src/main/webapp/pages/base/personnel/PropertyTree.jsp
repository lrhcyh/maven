...
<div class="easyui-panel" >
		<table id="province" class="easyui-treegrid" style="border:0;width: 100%;" data-options="
				...
				onBeforeExpand:function(node){
                  $.ajax({
            		url:'personnel/findTree.form?type=13254&id='+node.id,
            		type:'post',
               		async: false,
               		dataType:'text',
		...
		<thead>
			<tr>
				<th data-options="field:'text',width:'50%',align:'left',sortable:'true'"   >工作性质</th>
	...
	<script type="text/javascript">
	 $(function(){
			...
			var url = "personnel/findTree.form?type=13254&id=13254";
			$.ajax({
				url:url,
				type:"post",
				//data:data,
		...
		function findChildren(temp){
			 ...
			 /*  alert(temp.id);
			 alert(temp.text); */
			 $("#F207").textbox("setValue",temp.text);
