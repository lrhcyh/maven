...
<body>
<!-- 引入 echarts.js -->
 <link rel="stylesheet" href="excel/css/smartMenu.css?v=2016092003" />
 <script type="text/javascript" src="excel/js/jquery-smartMenu.js"></script>
  					...
  					<div class="easyui-tabs " style="width:200px;height:100%; " id="tabs">
					  		<div title="一维统计图" >
						  		<table class="easyui-datagrid" id="oneCartogram"  
									...
									},singleSelect:true,collapsible:true,url:'statistics/findCondition.form?moduleCode=2',method:'get',onSelect:
					    			function(index,row) {
							...
							data-options="onRowContextMenu: function(e, rowIndex, rowData){
									...
									},singleSelect:true,collapsible:true,onSelect:
					    			function(index,row) {
						  ...
						  <thead>
						   ...
						   <div id="mm1" class="easyui-menu" style="width:120px;display: none;">
		                    <div onclick="removeIt(2)" data-options="iconCls:'icon-remove'">删除</div>
	                      </div>
					       </table>
					  		</div>
					  </div>
  		...
  		<div style="padding:10px 20px 20px 20px">
		    <table cellpadding="5" style="width:400px;">
		    		<tr>
		    			...
		    			<td style="padding:10px 5"><input class="easyui-combobox"  id="vertical" style="width:96%" data-options="editable:false,url:'statistics/findCondition.form?moduleCode=2',method:'get',valueField:'accountcode',textField:'accountname',onShowPanel:function() {
		    			$('#vertical').combobox({
                        url:'statistics/findCondition.form?moduleCode=2'
                        });
		    		...
		    		<tr>
		    			...
		    			<td style="padding:10px 5"><input class="easyui-combobox"  id="horizontal" style="width:96%" data-options="editable:false,url:'statistics/findCondition.form?moduleCode=2',method:'get',valueField:'accountcode',textField:'accountname',onShowPanel:function() {
		    			$('horizontal').combobox({
                        url:'statistics/findCondition.form?moduleCode=2'
                        });
		    ...
		    <div style="text-align:center;padding:10px">
		    	<a  class="easyui-linkbutton" onclick="save()" style="width:80px;cursor:pointer;">保存</a>
		    	<a  class="easyui-linkbutton" onclick="statics()" style="margin-left:10px;width:80px;cursor:pointer;">统计</a>
		    	<a  class="easyui-linkbutton" onclick="out()" style="margin-left:10px;width:80px;cursor:pointer;">退出</a>
		    </div>
	    </div>
  </div>
<!--   <div id="commonWindow" class="easyui-window" title="常用统计"  data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:470,height:400">
  ...
  <div  class="easyui-window" id="commonTwoWindow" title="请输入统计名称" data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,width:300,heigth:120,modal:true">
   ...
   <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
    ...
    <div id="statisBox" class="easyui-window" title="查询"  data-options="collapsible:false,minimizable:false,maximizable:false,closed:true,modal:true" >
	  <div class="wpy-box" >
	  	<div class="form-item">
       ...
       $(this).combobox('reload');
	  	...
	  	<div class="wpy-bottom">
	  		<table style="width:100%;line-height:30px;" class="tj-table tj-table2" cellspacing="0">
	  			...
	  			<tr><td>
	  				<div id="texts" style="width:100%;height:120px;margin-top:10px; border:1px solid #ccc; background:#fff;">
