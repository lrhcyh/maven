...
public class DateUtils {
	 ...
	 * 获取数值型的时间，比如62125
	 * @param amount
	 * @return 返回格式化后的字符串,format:yyyy-MM-dd
	 */
	public static String getDateForString(String amount) {
        ...
        Date d = org.apache.commons.lang.time.DateUtils.addDays(c.getTime(), Integer.valueOf(amount));
